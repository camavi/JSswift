...
```json
{
  ...
  "props": {
    ...
    "removable": {
      "type": "boolean",
      "description": "Shows a remove affordance for chips/items.",
      "default": null,
      "values": null,
      "category": "general"
    },
    "onRemove": {
      "type": "function",
      "description": "Callback fired when an item is removed.",
      "default": null,
      "values": null,
      "category": "general"
    },

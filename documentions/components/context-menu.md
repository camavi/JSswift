...
```json
{
  ...
  "props": {
    ...
    "onTrigger": {
      "type": "(event, ctx) => boolean|void",
      "description": "Component configuration for \"onTrigger\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
  ...
  "slots": {
    ...
    "content": {
      "type": "Context menu content ({ close })",

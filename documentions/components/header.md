...
```json
{
  ...
  "props": {
    ...
    "drawerOpenIcon": {
      "type": "string|Node",
      "description": "Icon used for the drawer open control.",
      "default": null,
      "values": null,
      "category": "general"
    },
    "drawerCloseIcon": {
      "type": "string|Node",
      "description": "Icon used for the drawer close control.",
      "default": null,
      "values": null,
      "category": "general"
    },
    ...
    "slots": {
      "type": "{ left?, start?, right?, end?, center?, body?, icon?, eyebrow?, title?, subtitle?, meta?, content?, actions? }",
  ...
  "slots": {
    "left": {
      "type": "Left area, falls back to the drawer toggle",
    ...
    "start": {
      "type": "Alias/addon for the left area",
    ...
    "end": {
      "type": "Alias/addon for the right area",
    ...
    "content": {
      "type": "Extra content below the subtitle",
    ...
    "actions": {
      "type": "Actions grouped in the right area",

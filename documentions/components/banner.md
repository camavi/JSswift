...
```json
{
  ...
  "props": {
    ...
    "accent": {
      "type": "string",
      "description": "Component configuration for \"accent\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
    ...
    "actionsPlacement": {
      "type": "end|bottom",
      "description": "Component configuration for \"actionsPlacement\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
  ...
  "slots": {
    ...
    "default": {
      "type": "Extra banner body content",

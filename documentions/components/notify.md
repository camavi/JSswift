...
```json
{
  ...
  "props": {
    ...
    "id": {
      "type": "string",
      "description": "Component configuration for \"id\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
    ...
    "timeout": {
      "type": "number|false",
      "description": "Component configuration for \"timeout\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
    "duration": {
      "type": "Alias of timeout",
      "description": "Component configuration for \"duration\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
    ...
    "dismissLabel": {
      "type": "string",
      "description": "Component configuration for \"dismissLabel\". When not handled internally, it is forwarded to the root element.",
      "default": null,
      "values": null,
      "category": "general"
    },
    ...
    "slots": {
      "type": "{ icon?, title?, message?, description?, meta?, actions?, dismiss?, default? }",
  ...
  "slots": {
    "icon": {
      "type": "Leading visual/icon content",
    ...
    "default": {
      "type": "Extra body content under the message",

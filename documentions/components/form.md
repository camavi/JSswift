...
```json
{
  ...
  "props": {
    ...
    "form": {
      "type": "useForm() instance",
      "description": "HTML form attribute to associate controls with a form.",
      "default": null,
      "values": null,
      "category": "general"
    },
    "onSubmit": {
      "type": "async (model, form) => any",
      "description": "Callback fired when a form is submitted.",
      "default": null,
      "values": null,
      "category": "events"
    },
  ...
  "description": "Form component meta definition."
}
```
